...
<script>alert('insert Data sucessfull')</script>
...
// This indicates Javacript for all the events
...
<script type="text/javascript">
	...
	if (document.getElementById("name1").value == "julius" && document.getElementById("pass1").value =="real"){
		...
		document.getElementById("logValidate").innerHTML= "Dickson Katambi ";
		...
		<div id="entie" style="z-index: 1; ">
			...
			<div id="menuNav">
				...
				<div id="wideMenu">
					...
					<div id="logImage"></div>
					<h6 id="logValidate" style="font-family: Trebuchet MS; color: grey; font-weight: lighter; padding: 13px; margin-top: 4px; float: right; font-size: 19px; position: static; z-index: 1;">You must be loged in</h6>
	...
	<form method="POST" action="" id="formlog">
		...
		<div id="logForm">
			...
			<div id="formData">
				...
				<input type="text" name="Student" accept="numerial" placeholder="Student ID " required="" id="name1">

				<legend style="padding: 30px;margin-left: 42px;font-size: 23px; font-family: Trebuchet MS;">Password :</legend>

				<input type="password" name="Student" placeholder="password" required="" id="pass1">

				<input id="submit" onclick="TransToAccount()" type="submit" name="submit" value="LogIn">
	...
	<div id="pager" style="margin-left: 50px; padding: 50px;">
		...
		<div id="lessonContainer" style="margin: 67px;">
			...
			<div id="lessonChoice" style="width: 200px;height: 240px;background-color: #cfcfd0; margin-top: 50px; margin-left: 7px; ">
				...
				<a style="text-decoration: none;" href="http://localhost/Manfield_e_Velocity%20Web_Project/index.php" onclick="flip3d()"><p style=" font-size: 9px;font-family: Trebuchet MS; padding:  10px;color:red; text-decoration: none; margin-bottom: 10px;">Check Course-Outline</p></a>

				<h4 style="font-family: Trebuchet MS; padding: 6px; float: bottom;">Undergraduate || Information Technology</h4>


				<a style="text-decoration: none;" href="http://localhost/Manfield_e_Velocity%20Web_Project/index.php"><p style=" font-size: 9px;font-family: Trebuchet MS; padding:  10px;color:red; text-decoration: none; margin-top: -20px;">Narrow in Course</p></a>
			</div>
			...
			<div id="lessonChoice" style="width: 200px;height: 240px;background-color: #cfcfd0; margin-top: 50px; margin-left: 7px;">
				...
				<a style="text-decoration: none;" href="http://localhost/Manfield_e_Velocity%20Web_Project/index.php"><p style=" font-size: 9px;font-family: Trebuchet MS; padding:  10px;color:red; text-decoration: none; margin-bottom: 20px;">Check Course-Outline</p></a>
			...
			<div id="lessonChoice" style="width: 200px;height: 240px;background-color: #cfcfd0; margin-top: 50px;margin-left: 7px; ">
				...
				<a style="text-decoration: none;" href="http://localhost/Manfield_e_Velocity%20Web_Project/index.php"><p style=" font-size: 9px;font-family: Trebuchet MS; padding:  10px;color:red; text-decoration: none; margin-bottom: 20px;">Request BookCheck Course-Outline</p></a>
